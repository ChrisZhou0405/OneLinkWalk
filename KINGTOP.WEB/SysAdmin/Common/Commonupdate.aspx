<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Commonupdate.aspx.cs" Inherits="KingTop.WEB.SysAdmin.Common.Commonupdate" %>
...
<body>
    <form id="theForm" runat="server">
       <input type="hidden" id="hdnUploadImgUrl" value="<%=GetUploadImgUrl() %>" />
        ...
        <div class="container">
            ...
            <div id="panel">
                <dl>
                    <dt>标题</dt>
                    <dd>
                        <input class="validate[required]" type="text" style="width: 300px;" maxlength="512" name="Title" id="Title" runat="server" /><span style="color: #ff0000; font-size: 14px; font-weight: bold;">*</span></dd>
                </dl>
                <dl>
                    <dt>用户名</dt>
                    <dd>
                        <input class="validate[optional]" type="text" style="width: 300px;" maxlength="30" name="UserName" id="UserName"  runat="server" /></dd>
                </dl>
                <dl>
                    <dt>密码</dt>
                    <dd>
                        <input type="password" style="width: 300px;" maxlength="100" name="Password" id="Password"  runat="server" /></dd>
                </dl>
                <dl>
                    <dt>性别</dt>
                    <dd>
                        <input type="radio" id="MaleSex"  name="Sex" value="男"  runat="server" />男
                        <input type="radio" id="FemaleSex"   name="Sex" value="女"  runat="server" />女
                    </dd>
                </dl>
                <dl>
                    <dt>发布时间</dt>
                    <dd>
                        <input id="PubDate" name="PubDate" style="width: 200px;" class="Wdate" type="text" onfocus="WdatePicker({lang:'<%=Resources.Model.DateLang%>',skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'})"  runat="server" /></dd>
                </dl>
                <dl>
                    <dt>简介</dt>
                    <dd>
                        <textarea style="height: 80px; width: 500px;" class="validate[optional]" id="Intro" name="Intro"  runat="server" ></textarea>500字符以内，注：1个汉字等于2个字符</dd>
                </dl>
                <dl>
                    <dt>大图</dt>
                    <dd>
                        <input type="text" style="width: 300px;" name="BigImg" id="BigImg"  runat="server" />
                ...
                <dl>
                    <dt>小图</dt>
                    <dd>
                        <input type="text" style="width: 300px;" name="SmallImg" id="SmallImg"  runat="server" />
                                ...
                                <td valign="top">
                                    <ul style="list-style: none; padding:0; margin: 0;">
                                        <li style="margin: 0; padding: 0; margin-bottom: 5px;">
                                            <input type="hidden" id="listimage" name="listimage"  runat="server" />
                ...
                <dl>
                    ...
                    <dd>
                        ...
                        <div style="clear: left; padding-left: 8px">
                            <input type="hidden" name="PhotoAlbum" id="PhotoAlbum"  value="<%=PhotoAlbumStr %>" />
                ...
                <dl>
                    <dt>附件</dt>
                    <dd>
                        <input type="text" style="width: 300px;" name="Attach" id="Attach"  runat="server" />
                ...
                <dl>
                    <dt>兴趣</dt>
                    <dd>
                        <asp:ListBox ID="Interest" name="Interest" SelectionMode="Multiple" runat="server">
                            <asp:ListItem Value="篮球">篮球</asp:ListItem>
                            <asp:ListItem Value="足球">足球</asp:ListItem>
                            <asp:ListItem Value="羽毛球">羽毛球</asp:ListItem>
                            <asp:ListItem Value="桌球">桌球</asp:ListItem>
                        </asp:ListBox>
                        <%--<select id="Interest" multiple="multiple" name="Interest" runat="server">
        ...
        <input type="hidden" id="hdnModelAlias" value="通用功能自定义模块" name="hdnModelAlias" />

        <asp:HiddenField ID="hdnTableName" runat="server" Value="K_U_Common" />
        <asp:HiddenField ID="HidIsDel" runat="server" Value="" />
        <asp:HiddenField ID="HidIsEnable" runat="server" Value="" />
        <asp:HiddenField ID="HidIsArchiving" runat="server" Value="" />
        <asp:HiddenField ID="HidOrders" runat="server" Value="" />
        <asp:HiddenField ID="HidFlowState" runat="server" Value="" />
