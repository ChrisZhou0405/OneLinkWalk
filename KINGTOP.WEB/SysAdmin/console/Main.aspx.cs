...
--===============================================================*/
#endregion
namespace KingTop.Web.Admin.console
{
    public partial class Main : AdminPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                else if (Request.QueryString["action"] == "clear")  //清空缓存
                {
                    ClearCache();
                }
                GetLoginInfo();
        ...
        protected void GetEnvironmentInfo()
        {
            ...
            SysVersion = Utils.XmlRead(xmlPath, "SystemInfo/SystemType", "").Replace("KingTop ","")+"  V"+ Utils.XmlRead(xmlPath, "SystemInfo/SystemVer", "");
        ...
        protected string GetCPU()
        {
            ...
            //pc.NextValue();
            //Thread.Sleep(250);
            //cpuPro = (pc.NextValue() / Environment.ProcessorCount).ToString("0.0") + "%";
            return cpuPro;
        }
        //及时获得系统物理内存
        ...
        //{
        //    rptMessage.DataSource= new KingTop.BLL.SysManage.MessageSendee().GetMessageList(5, userID, SiteID.ToString());
        //    rptMessage.DataBind();
        //}
