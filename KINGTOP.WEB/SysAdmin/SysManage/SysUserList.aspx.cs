...
namespace KingTop.WEB.SysAdmin.SysManage
{
    public partial class SysUserList : AdminPage
    {
        ...
        public string ourNumCode = "";
        //逻辑层Account   
        KingTop.BLL.SysManage.Account BllAccount = new KingTop.BLL.SysManage.Account();
        //实体层Account
        KingTop.Model.SysManage.Account ModelAccount = new KingTop.Model.SysManage.Account();
        KingTop.BLL.SysManage.AccountSite bllAccSite = new KingTop.BLL.SysManage.AccountSite();
        ...
        {
            string[] strMessage = KingTop.Common.Utils.strSplit(e.CommandArgument.ToString(), "|");     //分隔传入的两个参数id、是否启用状态
        ...
        public string GetMyID(string numCode)
        {
            strEnable = "";
            if (numCode == ourNumCode && UserId!="0")
            {
