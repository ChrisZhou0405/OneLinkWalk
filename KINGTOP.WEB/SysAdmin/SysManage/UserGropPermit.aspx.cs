...
namespace KingTop.WEB.SysAdmin.SysManage
{
    public partial class UserGropPermit : AdminPage
    {
        ...
        public ArrayList arrOldRigth
        {
            get
            {
                if (KingTop.Common.AppCache.IsExist("arrOldRigth"))
                {
                    this._arrRigth = (ArrayList)KingTop.Common.AppCache.Get("arrOldRigth");
                }
            ...
            set
            {
                if (KingTop.Common.AppCache.IsExist("arrOldRigth"))
                {
                    KingTop.Common.AppCache.Remove("arrOldRigth");
                }
                KingTop.Common.AppCache.AddCache("arrOldRigth", value,120);
            }
        }
