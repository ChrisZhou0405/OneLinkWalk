<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TemplateNodeEdit.aspx.cs"
    Inherits="KingTop.WEB.SysAdmin.SysManage.TemplateNodeEdit" %>
    ...
    <script type="text/javascript">
        ...
        function showMessage() {
            ...
            if (type == 0) {
                ...
                msgContent += "<a href='TemplateNodeEdit.aspx?<%=KingTop.Common.Utils.GetUrlParams() %>' style='color:red'>继续添加</a>";
            ...
            msgContent += "<a href='TemplateNodeManage.aspx?NodeCode=<%=NodeCode %>&TemplateID=<%=TemplateID %>' style='color:blue'>返回列表</a> | ";
            msgContent += "<a href='TemplateNodeEdit.aspx?<%=KingTop.Common.Utils.GetUrlParams() %>' style='color:red'>继续修改</a> | ";
