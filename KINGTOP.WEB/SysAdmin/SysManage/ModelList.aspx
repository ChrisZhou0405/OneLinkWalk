<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModelList.aspx.cs" Inherits="KingTop.WEB.SysAdmin.SysManage.ModelList" %>
        ...
        <asp:Repeater ID="rptModelList" runat="server">
            <ItemTemplate>
                <ul class="ulheader ulbody">
                    ...
                    <li style="width: 5%">
                        <%#KingTop.Common.Utils.ParseIsOrNot((Eval("IsSystem").ToString()),"0")%></li>
                    <li style="width: 6%">
                    ...
                    <asp:LinkButton ID="lnkbState" class="abtn" runat="server" OnCommand="ModelList_State"
                           CommandName="Statedp" ToolTip='<%#Eval("ModuleName")%>' CommandArgument='<%#Eval("ModuleID")+"|"+Eval("IsValid") %>'><%# KingTop.Common.Utils.ParseStateTitle(!KingTop.Common.Utils.ParseBool(Eval("IsValid").ToString()), "0")%></asp:LinkButton>
