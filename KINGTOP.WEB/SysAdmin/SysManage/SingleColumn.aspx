<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="SingleColumn.aspx.cs" Inherits="KingTop.WEB.SysAdmin.SysManage.SingleColumn" %>
    ...
    <script type="text/javascript">
        ...
        function showMessage() {
            ...
            if (type == 0) {
                ...
                msgContent += "<a href='SingleColumn.aspx?<%=KingTop.Common.Utils.GetUrlParams() %>' style='color:red'>继续添加</a> | ";
                ...
                msgContent += "<a href='SingleColumn.aspx?<%=KingTop.Common.Utils.GetUrlParams() %>' style='color:red'>继续修改</a>";
                if (editSelfMenuUrl != "") {
        ...
        <div id="con">
            ...
            <div id="panel">
                ...
                <fieldset>
                    ...
                    <dl>
                        <dt>英文名称：</dt>
                        <dd><asp:TextBox ID="txtNodelEngDesc"  Width="231px" runat="server"></asp:TextBox></dd>
                    </dl> 
                    <dl>
                        <dt>栏目目录名：</dt>
                        <dd><asp:TextBox ID="txtNodeDir" CssClass="validate[custom[noSpecialCaracters]]"  Width="231px" runat="server"></asp:TextBox>(如果站点发布为静态并且是父节点，必须填写）</dd>
                    </dl>
                    <dl>
                    ...
                    <dl>
                        <dt>前台程序路径：</dt>
                        <dd><asp:TextBox ID="txtSubDomain" runat="server" Width="231px"></asp:TextBox>(例如：/aboutindex.aspx?m=105001002 )</dd>
                    </dl>
                    <dl>
                        <dt>前台栏目自定义链接：</dt>
                ...
                <fieldset style="display: none;">
                    ...
                    <select id="selMenuType" name="selMcenuType" onchange="location.href=this.value;">
                        ...
                        <option value="SingleColumn.aspx<%=strurlpar %>" selected>单页栏目</option>
                    ...
                    <dl>
                        <dt>栏目Banner：</dt>
                        <dd><asp:TextBox ID="txtBanner" runat="server" Width="252px"></asp:TextBox> <input type="button" id="Button4" value="上传" runat="server" Class="subButton" onclick="InputFile('theForm','txtBanner','image',1,'jpg|gif|bmp|png|swf|flv','','','','',0,'','');" /></dd>
                    </dl>
                    <dl>
                        <dt>栏目图标(如果前台栏目导航选择图片方式，则需上传，下同)：</dt>
                        <dd><asp:TextBox ID="txtNodelIcon" runat="server" Width="252px"></asp:TextBox> <input type="button" id="Button3" value="上传" runat="server" Class="subButton" onclick="InputFile('theForm','txtNodelIcon','image',1,'jpg|gif|bmp|png','','','','',0,'','');" /></dd>
                    </dl>
                    <dl>
                        <dt>当前栏目图标：</dt>
                        <dd><asp:TextBox ID="txtCurrentImg" runat="server" Width="252px"></asp:TextBox> <input type="button" id="Button1" value="上传" runat="server" Class="subButton" onclick="InputFile('theForm','txtCurrentImg','image',1,'jpg|gif|bmp|png','','','','',0,'','');" /></dd>
                    </dl>
                    <dl>
                        <dt>鼠标移上去图标（鼠标移上去图标与当前栏目图标一样，则不必上传）：</dt>
                        <dd><asp:TextBox ID="txtMouseOverImg" runat="server" Width="252px"></asp:TextBox> <input type="button" id="Button2" value="上传" runat="server" Class="subButton" onclick="InputFile('theForm','txtMouseOverImg','image',1,'jpg|gif|bmp|png','','','','',0,'','');" /></dd>
                    </dl>
                    <dl>
                        <dt>打开方式：</dt>
