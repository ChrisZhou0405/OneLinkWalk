<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActionList.aspx.cs" Inherits="KingTop.Web.Admin.ActionList" %>
    ...
    <div class="container">
        ...
        <div id="searchContainer">
            <p>
                ...
                <option value="OperName"<%if(KingTop.Common.Utils.UrlDecode(Request.QueryString["searchType"])=="OperName"){Response.Write(" selected");} %>>操作名称</option>
                </select>
                ...
                <ul class="ulheader ulbody">
                    ...
                    <li style="width: 13%">
                        <asp:LinkButton ID="lnkbState" class="abtn" runat="server" OnCommand="ActionList_State"
                            CommandName="Statedp" ToolTip='<%#Eval("OperName")%>' CommandArgument='<%#Eval("ID")+"|"+Eval("IsValid") %>'><%# KingTop.Common.Utils.ParseStateTitle(!KingTop.Common.Utils.ParseBool(Eval("IsValid").ToString()), "0")%></asp:LinkButton> 
