<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TemplateEdit.aspx.cs" Inherits="KingTop.WEB.SysAdmin.SysManage.TemplateEdit" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showMessage() {
            ...
            msgContent += "<a href='TemplateEdit.aspx?<%=KingTop.Common.Utils.GetUrlParams() %>' style='color:red'>继续修改</a> | ";
