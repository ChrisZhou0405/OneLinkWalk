<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysUserEdit.aspx.cs" Inherits="KingTop.WEB.SysAdmin.SysManage.SysUserEdit" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        //添加成功
            if (type == 0) {
                ...
                msgContent += "<a href='SysUserEdit.aspx?<%=KingTop.Common.Utils.GetUrlParams() %>'class='reclose' style='color:red'>继续修改</a> | ";
