<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebSiteManage.aspx.cs" Inherits="KingTop.WEB.SysAdmin.SysManage.WebSiteManage" %>
                ...
                <ItemTemplate>
                    ...
                    <li style="width: 6%;text-align:center">
                       ...
                       <li style="width: 19%">
                        ...
                        <li style="width:35%">
                            <%#GetUpdateMenu(Eval("SiteID").ToString ()) %>
