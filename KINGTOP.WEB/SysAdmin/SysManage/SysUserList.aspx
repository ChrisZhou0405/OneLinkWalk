<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysUserList.aspx.cs" Inherits="KingTop.WEB.SysAdmin.SysManage.SysUserList" %>
    ...
    <div class="container">
        ...
        <div id="searchContainer">
            <p>
                ...
                <asp:Button ID="btnSearch" runat="server" Text="<%$Resources:Common,Search %>"
        ...
        <asp:Repeater ID="RptUser" runat="server">
            <ItemTemplate>
                <ul class="ulheader ulbody">
                    <li style="width: 5%; text-align:center">
                        <input type="checkbox" name="chkId" value='<%#Eval("ID") %>' <%#GetMyID(Eval("NumCode").ToString())%> />
                    </li>
                    ...
                    <li style="width: 15%;text-align:center">
                        <%#KingTop.Common.Utils.GetStandardDateTime(Eval("AddDate").ToString())%>
                    </li>
                    <li style="width: 10%;text-align:center">
                        <%#KingTop.Common.Utils.ParseState((Eval("IsValid")),"0")%>
                    </li>
                    <li style="width: 20%">
                        ...
                        <asp:LinkButton ID="lnkbState" class="abtn" style='<%#strEnable=="disabled"?"display:none":""%>'  runat="server" OnCommand="SysUserList_State"
                            CommandName="Statedp" ToolTip='<%#Eval("UserName")%>' CommandArgument='<%#Eval("ID")+"|"+Eval("IsValid") %>'><%# KingTop.Common.Utils.ParseStateTitle(!KingTop.Common.Utils.ParseBool(Eval("IsValid").ToString()), "0")%></asp:LinkButton> 
