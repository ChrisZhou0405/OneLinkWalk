<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false"  CodeBehind="OutLinkColumn.aspx.cs" Inherits="KingTop.WEB.SysAdmin.SysManage.OutLinkColumn" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function showMessage() {
            ...
            if (type == 0) {
                ...
                msgContent += "<a href='OutLinkColumn.aspx?<%=KingTop.Common.Utils.GetUrlParams() %>' style='color:red'>继续添加</a> | ";
                ...
                msgContent += "<a href='OutLinkColumn.aspx?<%=KingTop.Common.Utils.GetUrlParams() %>' style='color:red'>继续修改</a>";
                if (editSelfMenuUrl != "") {
            ...
            <div id="panel">
                ...
                <fieldset style="display:none">
                    ...
                    <select id="selMenuType" name="selMcenuType" onchange="location.href=this.value;">
                        ...
                        <option value="OutLinkColumn.aspx<%=strurlpar %>" selected>外部连接栏目</option>
                    </select>
