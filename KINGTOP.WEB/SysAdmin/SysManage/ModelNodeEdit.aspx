<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModelNodeEdit.aspx.cs"
    Inherits="KingTop.WEB.SysAdmin.SysManage.ModelNodeEdit" %>
    ...
    <script type="text/javascript">
        ...
        function showMessage() {
            ...
            if (type == 0) {
                ...
                msgContent += "<a href='ModelNodeEdit.aspx?<%=KingTop.Common.Utils.GetUrlParams() %>' style='color:red'>继续添加</a>";
            ...
            msgContent = "修改节点<font color=red>" + title + "</font>成功<br>";
                ...
                msgContent += "<a href='ModelNodeEdit.aspx?<%=KingTop.Common.Utils.GetUrlParams() %>' style='color:red'>继续修改</a> <br> ";
                //msgContent += "<a href='ModelNodeEdit.aspx?<%=KingTop.Common.Utils.GetUrlParams().Replace("Edit","New") %>' style='color:red'>添加新节点</a><br>";
        ...
        <div id="con">
            <div id="panel">
                ...
                <dl>
                    <dt>节点名称：</dt>
                    <dd>
                       <asp:TextBox ID="txtNodeName" runat="server" CssClass="validate[required,length[2,30]]"></asp:TextBox>
                ...
                <dl>
                    <dt>英文名称：</dt>
                    <dd><asp:TextBox ID="txtNodelEngDesc" class="validate[required,custom[onlyLetter],length[0,30]] text-input" runat="server"></asp:TextBox></dd>
                </dl>
                <dl>
