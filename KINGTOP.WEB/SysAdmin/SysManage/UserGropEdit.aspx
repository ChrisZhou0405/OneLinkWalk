<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserGropEdit.aspx.cs" Inherits="KingTop.WEB.SysAdmin.SysManage.UserGropEidt" %>
    ...
    <script type="text/javascript">
        ...
        //添加成功
            if (type == 0) {
                ...
                msgContent += "<a href='UserGropEdit.aspx?<%=KingTop.Common.Utils.GetUrlParams() %>' style='color:red'>继续修改</a> | ";
