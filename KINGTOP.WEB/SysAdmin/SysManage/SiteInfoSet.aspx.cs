...
namespace KingTop.WEB.SysAdmin.SysManage
{
    public partial class SiteInfoSet : AdminPage
    {
        ...
        {            
            ...
            this.txtLogo.Text = M_SiteInfoConfig.Logo;
            this.txtFavicon.Text = M_SiteInfoConfig.Favicon;
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (IsHaveRightByOperCode("Edit"))
            {
                ...
                M_SiteInfoConfig.Logo = this.txtLogo.Text;
                M_SiteInfoConfig.Favicon = this.txtFavicon.Text;
                SiteInfo.ConfigInfo = M_SiteInfoConfig;
