<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PostSet.aspx.cs" Inherits="KingTop.WEB.SysAdmin.SysManage.PostSet" %>
...
<body>
    ...
    <div class="container">
        ...
        <div id="panel">
                <dl>
                    <dt width="30%"><b>发送人邮箱:</b><br>例：someone@toprand.com</dt>
                ...
                <dl>
                    <dt width="30%"><b>端口号：</b><br>端口号必需是正整数，默认是25端口 </dt>
