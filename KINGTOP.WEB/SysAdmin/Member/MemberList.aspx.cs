...
namespace KingTop.Web.Admin
{
    public partial class MemberList :AdminPage
    {
       ...
       //DataTable dtMemberModel = new DataTable();
        ...
        {
            //dtMemberModel = (new KingTop.BLL.Business.BusinessModel()).GetList("MEMBER", Utils.getOneParams(SiteID.ToString()));
        ...
        {
            KingTop.Modules.Pager p = new KingTop.Modules.Pager();
        ...
        private void OnCheck(string setValue)
        {
            if (IsHaveRightByOperCode("Check"))
            {
                ...
                if (!string.IsNullOrEmpty(chkIdList))
                {
                    bllMember.MemberSet("CHECK", setValue, chkIdList);  //锁定/解锁
                }
            ...
            {
                Utils.AlertMessage(this, "你没有审核会员的权限！");
            }
        }
        ...
        public string GetCheck(string checkValue)
        {
