...
(function() {
    ...
    */
    var URL;
    window.UEDITOR_HOME_URL = "/sysadmin/editor/ueditor/";
    /**
    ...
    */
    window.UEDITOR_CONFIG = {
        ...
        , imageUrl: URL + "net/udupload.aspx"
        ...
        //涂鸦图片配置区
        , scrawlUrl: URL + "net/udupload.aspx"           //涂鸦上传地址
        , scrawlPath: URL + "net/"                           //图片修正地址，同imagePath

        //附件上传配置区
        //,fileUrl:URL+"net/fileUp.ashx"               //附件上传提交地址
        , fileUrl: URL + "net/udupload.aspx"               //附件上传提交地址
        ...
        //屏幕截图配置区
        , snapscreenHost: '192.168.1.155'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        , snapscreenServerUrl: URL + "net/udupload.aspx" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
        , snapscreenPath: URL + "net/"
        , snapscreenServerPort: 1043                                    //屏幕截图的server端端口
        //,snapscreenImgAlign: 'center'                                //截图的图片默认的排版方式

        //word转存配置区
        , wordImageUrl: URL + "net/udupload.aspx"             //word转存提交地址
        ...
        //'imagecenter', '|', 'insertimage', 'emotion','scrawl', 'insertvideo', 'attachment', 'map', 'gmap', 'insertframe','highlightcode','webapp','pagebreak','template','background', '|',
                'imagecenter', '|', 'insertimage', 'emotion', 'insertvideo', 'attachment', 'map', 'gmap', 'insertframe', 'highlightcode', 'webapp', 'pagebreak', 'template', 'background', '|',
