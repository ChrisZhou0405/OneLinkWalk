...
<div id="panel"><dl><dt>标题：</dt><dd id="K_U_Category_Title"><%=hsFieldValue["Title"]%></dd></dl></div>
<asp:HiddenField Value="K_U_Category" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000005585679" runat="server" />
</div>
