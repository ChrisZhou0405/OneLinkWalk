...
<asp:HiddenField ID="hdnHtmlField" Value="editor_ProjectIntro" runat="server" />
...
<div id="panel"><dl><dt>项目名称</dt><dd><input  class="validate[required]"  type="text" value="<%=FormatInputValue(hsFieldValue["Title"].ToString())%>" style="width:300px;"  maxlength="512" name="Title" id="Title" /><span style="color:#ff0000; font-size:14px; font-weight:bold;">*</span></dd></dl><dl><dt>项目介绍</dt><dd><uc1:Editor ID="editor_ProjectIntro" runat="server" width="680" height="450" IsFirstEditor="true"/></dd></dl></div>
<div class="Submit" id="HQB_Operation_Button">
 ...
 <asp:HiddenField ID="hdnFieldFromUrlParamValue" runat="server" Value="" /><asp:hiddenfield ID="hdnNodeCode" runat="server"/><asp:HiddenField Value="K_U_ProjectOver" ID="hdnTableName" runat="server" /><asp:HiddenField Value="Title||1,ProjectIntro||3," ID="hdnFieldValue" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000008359127" runat="server" /><input type="hidden" id="hdnModelAlias" value="项目概述" name="hdnModelAlias"/> 
