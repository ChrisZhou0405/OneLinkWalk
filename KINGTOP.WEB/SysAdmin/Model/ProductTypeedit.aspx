...
<div id="panel"><dl><dt>标题</dt><dd><input  class="validate[optional]"  type="text" value="<%=FormatInputValue(hsFieldValue["Title"].ToString())%>" style="width:180px;"  maxlength="512" name="Title" id="Title" /></dd></dl><dl><dt>审核状态</dt><dd><select  id="FlowState" name="FlowState"><option  <%if(hsFieldValue["FlowState"] != null && hsFieldValue["FlowState"].ToString()=="0") {Response.Write("selected='selected'");}%> value="0">审核不通过</option><option  <%if(hsFieldValue["FlowState"] != null && hsFieldValue["FlowState"].ToString()=="3") {Response.Write("selected='selected'");}%> value="3">待审</option><option  <%if(hsFieldValue["FlowState"] != null && hsFieldValue["FlowState"].ToString()=="99") {Response.Write("selected='selected'");}%> value="99">审核通过</option></select></dd></dl></div>
<div class="Submit" id="HQB_Operation_Button">
 ...
 <asp:HiddenField ID="hdnFieldFromUrlParamValue" runat="server" Value="" /><asp:hiddenfield ID="hdnNodeCode" runat="server"/><asp:HiddenField Value="K_U_ProductType" ID="hdnTableName" runat="server" /><asp:HiddenField Value="Title||1,FlowState|99|6," ID="hdnFieldValue" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000001445312" runat="server" /><input type="hidden" id="hdnModelAlias" value="产品类别" name="hdnModelAlias"/> 
