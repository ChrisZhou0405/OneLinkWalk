...
<div id="panel"><dl><dt>项目名称：</dt><dd id="K_U_ProjectOver_Title"><%=hsFieldValue["Title"]%></dd></dl><dl><dt>项目介绍：</dt><dd id="K_U_ProjectOver_ProjectIntro"><%=hsFieldValue["ProjectIntro"]%></dd></dl></div>
<asp:HiddenField Value="K_U_ProjectOver" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000008359127" runat="server" />
</div>
