...
<div id="panel"><dl><dt>发言人：</dt><dd id="K_U_jlhd_Title"><%=hsFieldValue["Title"]%></dd></dl><dl><dt>发言内容：</dt><dd id="K_U_jlhd_Descripts"><%=hsFieldValue["Descripts"]%></dd></dl><dl><dt>回答：</dt><dd id="K_U_jlhd_Intro"><%=hsFieldValue["Intro"]%></dd></dl></div>
<asp:HiddenField Value="K_U_jlhd" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000000172283" runat="server" />
</div>
