        ...
        private void BasicFieldInit(DataRow drField)
        {
            ...
            switch (basicField)
            {
                ...
                case "12":  // 文件
                    ...
                    txtDataCoulumnLength.Text = drField["DataColumnLength"].ToString();                  // 字段表长度
                    txtDefaultValue.Text = drField["DefaultValue"].ToString();                           // 默认值
                    txtImageBestWidth.Text = drField["ImageBestWidth"].ToString();
                    txtImageBestHeight.Text = drField["ImageBestHeight"].ToString();
                    if (basicField == "11")
                    {
                ...
                switch (basicFiledType)
                {
                    ...
                    case 7:   // 列表（可选择多列） 
                        ...
                        else if (string.Equals(radlDropDownDataType.SelectedValue, "2"))                           // 数据库读取方式
                        {
                            ...
                            this.hsFieldParam.Add("DropDownTextColumn", Request.Form ["ddlDropDownTextColumn"]);                     // Text列
                            this.hsFieldParam.Add("DropDownValueColumn", Request.Form ["ddlDropDownValueColumn"]);                   // Value列  
                    ...
                    case 12:  // 文件 
                        ...
                        if (basicFiledType == 11)
                        {
                            ...
                            this.hsFieldParam.Add("ImageBestWidth", Utils.ParseInt(txtImageBestWidth.Text, 0));
                            this.hsFieldParam.Add("ImageBestHeight", Utils.ParseInt(txtImageBestHeight.Text, 0));
