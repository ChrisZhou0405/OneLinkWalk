...
<div id="panel"><dl><dt>美食类别：</dt><dd id="K_U_FoodCategory_Title"><%=hsFieldValue["Title"]%></dd></dl><dl><dt>类别Banner：</dt><dd id="K_U_FoodCategory_BigImg"><%=hsFieldValue["BigImg"]%></dd></dl></div>
<asp:HiddenField Value="K_U_FoodCategory" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000006979731" runat="server" />
</div>
