...
<div class="Submit" id="HQB_Operation_Button">
 ...
 <asp:HiddenField ID="hdnFieldFromUrlParamValue" runat="server" Value="" /><asp:hiddenfield ID="hdnNodeCode" runat="server"/><asp:HiddenField Value="K_U_DownloadType" ID="hdnTableName" runat="server" /><asp:HiddenField Value="Title||1," ID="hdnFieldValue" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000003575732" runat="server" /><input type="hidden" id="hdnModelAlias" value="下载类型" name="hdnModelAlias"/> 
