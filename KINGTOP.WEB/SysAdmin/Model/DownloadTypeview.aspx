...
<div id="panel"><dl><dt>标题：</dt><dd id="K_U_DownloadType_Title"><%=hsFieldValue["Title"]%></dd></dl></div>
<asp:HiddenField Value="K_U_DownloadType" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000003575732" runat="server" />
</div>
