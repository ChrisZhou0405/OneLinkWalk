...
<div id="panel"><dl><dt>标题：</dt><dd id="K_U_gszl_Title"><%=hsFieldValue["Title"]%></dd></dl><dl><dt>内容：</dt><dd id="K_U_gszl_Content"><%=hsFieldValue["Content"]%></dd></dl></div>
<asp:HiddenField Value="K_U_gszl" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000000172289" runat="server" />
</div>
