...
<div id="panel"><dl><dt>标题：</dt><dd id="K_U_Honor_Title"><%=hsFieldValue["Title"]%></dd></dl><dl><dt>大图：</dt><dd id="K_U_Honor_BigImg"><%=hsFieldValue["BigImg"]%></dd></dl><dl><dt>小图：</dt><dd id="K_U_Honor_SmallImg"><%=hsFieldValue["SmallImg"]%></dd></dl></div>
<asp:HiddenField Value="K_U_Honor" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000000172301" runat="server" />
</div>
