...
<div id="panel"><dl><dt>标题：</dt><dd id="K_U_prod_Title"><%=hsFieldValue["Title"]%></dd></dl><dl><dt>详细内容：</dt><dd id="K_U_prod_Contents"><%=hsFieldValue["Contents"]%></dd></dl></div>
<asp:HiddenField Value="K_U_prod" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000002181259" runat="server" />
</div>
