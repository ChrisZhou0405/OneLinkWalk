<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="KingTop.WEB.En.index" %>
        ...
        <div class="wrapper">
            ...
            <div class="main">
                <div class="navLink">
                    <ul>
                        <li>
                            <a href="/En/shopping/index.aspx" onmouseover="abc(0,0,4);" onmouseout="cad(0)"></a>
                            <div>
                        ...
                        <li>
                            <a href="/En/cate/index.aspx" onmouseover="abc(1,0,4);" onmouseout="cad(1)"></a>
                            <div>
                        ...
                        <li>
                            <a href="/En/activity/index.aspx" onmouseover="abc(2,0,7);" onmouseout="cad(2)"></a>
                            <div>
...
c0-1.1-0.1-2.7-0.1-4.2C74,22,64,22.2,60.2,24C60.2,21.3,60.2,19.2,60.2,19.2z" />
                        ...
                        <li class="nobg">
                            <a href="/En/vip/nonmember.aspx?node=101005001" onmouseover="abc(3,0,4);" onmouseout="cad(3)"></a>
                            <div>
