...
namespace KingTop.WEB.En.cate
{
    public partial class detail : System.Web.UI.Page
    {
        ...
        {
            using (DataTable dt = KingTop.Common.SQLHelper.GetDataSet("SELECT ID,NodeCode,Title,type,ShopNo,Stereogram,LocationImg,TelPhone,SalesPro,SiteURL,IntroDetail,Shopshow,ShopLogo,Floor,MetaKeyword,MetaDescript FROM K_U_FoodGuide Where NodeCode='104003002' and isdel=0  and id='" + id + "' and flowstate=99"))
            {
                if (dt.Rows.Count > 0)
                {
        ...
        private void BindRelated()
        {
            ...
            sql = "select top 5 ID,NodeCode,Title,type,ShopNo,Stereogram,LocationImg,TelPhone,SalesPro,SiteURL,IntroDetail,Shopshow,LikeImg,Orders FROM K_U_FoodGuide where NodeCode='104003002' and isdel=0 and  len(LikeImg)>0 and ID not in (" + id + ") and flowstate=99 order by orders desc";
