<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="detail.aspx.cs" Inherits="KingTop.WEB.En.cate.detail" %>
...
<%@ Register Src="~/En/Controls/share.ascx" TagPrefix="uc1" TagName="share" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="mains">
            <div class="wrap">
                <asp:Repeater ID="rptlist" runat="server">
                    <ItemTemplate>
                        ...
                        <div class="shopDtxt">
                            ...
                            <span>
                                <i>Shop：<%#Eval("Title")%></i>
                                <i>Location：<%#Eval("ShopNo")%><em class="btnSite">地图</em></i>
                                <i>Tel：<%#Eval("TelPhone")%></i>
                                <i>Product：<%#Eval("SalesPro")%></i>
                                <i>URL：<a  target="_blank" href="http://<%#Eval("SiteURL")%>"><%#Eval("SiteURL")%></a></i>
                            </span>
                ...
                <div class="hotShop">
                    <h1><span>You may also like it</span></h1>
                    <!-- picScroll -->
        ...
        <div id="data_lc2" style="display: none;" lc_f_width="1812" lc_f_height="354" lc_btn_imgurl="../images/lcimages/f2/f2_btn.png" lc_imgurl="/En/images/lcimages/f2/f2_bg.png">
