    ...
    public class getData : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (KingTop.Common.Tools.CheckSql(context.Request .QueryString["locaiton"]) != "")
            {
                ...
                sql = "SELECT Top 1 ID,NodeCode,Title,type,ShopNo,Stereogram,LocationImg,TelPhone,SalesPro,SiteURL,IntroDetail,Shopshow,ShopLogo,Orders FROM K_U_CategoryGuide where NodeCode='101002002' and isdel=0 and flowstate=99" + wherestr + " order by orders desc";
        ...
        string  getDt(DataTable dt)
        {
            ...
            if(d.Length>120)
            {
             ...
             s.Append("<p>" +d+ "</p>");
             s.Append("  <a href=\"/En/detail2.aspx?nid="+dt.Rows[0]["id"]+" id=\"bl_txt_a\">了解详情</a>");
                s.Append( "</div>");
              s.Append("    </div>");
            return s.ToString();
