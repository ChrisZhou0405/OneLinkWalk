<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="detail2.aspx.cs" Inherits="KingTop.WEB.En.shopping.detail2" %>
                    ...
                    <ItemTemplate>
                        ...
                        <div class="shopDtxt">
                            ...
                            <span>
                                ...
                                <i>Shop：<%#Eval("Title")%></i>
                                <i>Location：<%#Eval("ShopNo")%><em class="btnSite">Map</em></i>
                                <i>Tel：<%#Eval("TelPhone")%></i>
                                <i>Product：<%#Eval("SalesPro")%></i>
                                <i>URL：<a href="http://<%#Eval("SiteURL")%>" target="_blank"><%#Eval("SiteURL")%></a></i>
                            </span>
     ...
     <div class="picScroll5">
       ...
       <div class="bd">
        ...
        <ul>
                                    ...
                                    <ItemTemplate>
                                        <li>
                                            <a href="/En/shopping/detail2.aspx?nid=<%#Eval("ID") %>">
...
<!--footer end-->
  ...
  <div class="lMap"><h1 class="close"></h1>
