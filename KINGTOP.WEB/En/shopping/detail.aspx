<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="detail.aspx.cs" Inherits="KingTop.WEB.En.shopping.detail" %>
    ...
    <form id="form1" runat="server">
                ...
                <asp:Repeater ID="rptlist" runat="server">
                    <ItemTemplate>
                        <div class="title">
                            <%#Eval("Title")%>
                            <span>分享: 
                                <a href="#" class="ds_wx"></a>
                                <a href="#" class="ds_en"></a>
                                <a href="#" class="ds_qq"></a>
                                <a href="#" class="ds_sn"></a>
                                <a href="#" class="ds_bou"></a>
                            </span>
                        </div>
                        ...
                        <div class="shopDtxt">
                            ...
                            <span>
                                <input type="hidden"  id="shopNo2" value="<%#Eval("ShopNo")%>"/>
                                <i>店铺名称：<%#Eval("Title")%></i>
                                <i>位置：<%#Eval("ShopNo")%><em class="btnSite">地图</em></i>
                                <i>电话：<%#Eval("TelPhone")%></i>
                                <i>销售产品：<%#Eval("SalesPro")%></i>
                                <i>网址：<a href="http://<%#Eval("SiteURL")%>" target="_blank"><%#Eval("SiteURL")%></a></i>
                            </span>
        ...
        <ico icourl="/En/images/lcimages/ico_7.png" icovalue="ATM" icoclass="ico_txt2" icopos="right"></ico>
            ...
            <asp:Repeater ID="rptdata0lclist" runat="server">
                    <ItemTemplate>
                        <lc lcnum="<%#Eval("lcnum")%>" lcname="<%#Eval("Title")%>" lcoverimgurl="<%#Eval("lcoverimgurl")%>" lcx="<%#Eval("lcx")%>" lcy="<%#Eval("lcy")%>"  lclink="/shopping/site2.aspx?id=<%#Eval("cID") %>" lclink2="/shopping/detail2.aspx?nid=<%#Eval("cID") %>"  lccoords="<%#Eval("lccoords")%>"></lc>
                    </ItemTemplate>
                </asp:Repeater>
        </div>
        ...
        <ico icourl="/En/images/lcimages/ico_6.png" icovalue="餐饮" icoclass="ico_txt2" icopos="right"></ico>
            <asp:Repeater ID="rptdatalc1list" runat="server">
                    <ItemTemplate>
                        <lc lcnum="<%#Eval("lcnum")%>" lcname="<%#Eval("Title")%>" lcoverimgurl="<%#Eval("lcoverimgurl")%>" lcx="<%#Eval("lcx")%>" lcy="<%#Eval("lcy")%>"  lclink="/En/shopping/site2.aspx?id=<%#Eval("cID") %>" lclink2="/En/shopping/detail2.aspx?nid=<%#Eval("cID") %>" lccoords="<%#Eval("lccoords")%>"></lc>
                    </ItemTemplate>
                </asp:Repeater>
        </div>
        ...
        <script type="text/javascript">
            ...
            var data = document.getElementById("data_lc" + 0);
            document.getElementById("lc_f_id2").getElementsByTagName("area")[0].removeAttribute("onmouseout");
            /*地图点位动态创建*/
