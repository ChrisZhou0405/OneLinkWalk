<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="traffic.aspx.cs" Inherits="KingTop.WEB.En.about.traffic" %>
    ...
    <style>
        * {
        ...
        .navlist1 {
            width: 86px;
            height: 387px;
            background: url("/En/images/ddfs_right.png") no-repeat;
            position: absolute;
            ...
            .navlist1 li {
                ...
                .navlist1 li div {
                    width: 100%;
                    height: 100%;
                    background: url("/En/images/ico_opa_bg.png") no-repeat;
                    display: block;
                }
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="mains">
            <div class="wrap">
                <div class="title">Arrival mode </div>
                <div class="traffic">
                    <div class="ddfs">
                        <ul class="navlist1">
                    ...
                    <div class="traffics">
                        <h2>「Wan Ling Department of Transportation」</h2>
                        <ul class="tfList">
        ...
        <script>
            function changeImg(n) {
                ...
                bigimg.src = "/En/images/ddfs" + n + ".gif";
