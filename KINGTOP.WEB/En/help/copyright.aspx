<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="copyright.aspx.cs" Inherits="KingTop.WEB.En.help.copyright" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="mains">
            <div class="wrap">
                ...
                <ul class="crList">
                    <%=KingTop.Common.Tools.GetSinglePageContent("104008002")%>
                </ul>
            </div>
        </div>
        <!--main end-->
