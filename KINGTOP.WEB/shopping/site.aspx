<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="site.aspx.cs" Inherits="KingTop.WEB.shopping.site" %>
        ...
        <div class="mains mt148">
                    ...
                    <ul class="sideBar">
                        ...
                        <li><a class="si_2" href="javascript:;">按字母</a>
                            <div class="letter">
                                <span>
                                    <h2>A - D</h2>
                                    <p><i onclick="javascript:location='index.aspx?Loacation=1'">A</i><i onclick="javascript:location='index.aspx?Loacation=2'">B</i><i onclick="javascript:location='index.aspx?Loacation=3'">C</i><i onclick="javascript:location='index.aspx?Loacation=4'">D</i></p>
                                </span>
                                <span>
                                    <h2>E - H</h2>
                                    <p>
                                        <i onclick="javascript:location='index.aspx?Loacation=5'">E</i>
                                        <i onclick="javascript:location='index.aspx?Loacation=6'">F</i>
                                        <i onclick="javascript:location='index.aspx?Loacation=7'">G</i>
                                        <i onclick="javascript:location='index.aspx?Loacation=8'">H</i>
                                    </p>
                                </span>
                                <span>
                                    <h2>I - L</h2>
                                    <p>
                                        <i onclick="javascript:location='index.aspx?Loacation=9'">I</i>
                                        <i onclick="javascript:location='index.aspx?Loacation=10'">J</i>
                                        <i onclick="javascript:location='index.aspx?Loacation=11'">K</i>
                                        <i onclick="javascript:location='index.aspx?Loacation=12'">L</i>
                                    </p>
                                </span>
                                <span>
                                    <h2>M - P</h2>
                                    <p>
                                        <i onclick="javascript:location='index.aspx?Loacation=13'">M</i>
                                        <i onclick="javascript:location='index.aspx?Loacation=14'">N</i>
                                        <i onclick="javascript:location='index.aspx?Loacation=15'">O</i>
                                        <i onclick="javascript:location='index.aspx?Loacation=16'">P</i>
                                    </p>
                                </span>
                                <span>
                                    <h2>Q - T</h2>
                                    <p>
                                        <i onclick="javascript:location='index.aspx?Loacation=17'">Q</i>
                                        <i onclick="javascript:location='index.aspx?Loacation=18'">R</i>
                                        <i onclick="javascript:location='index.aspx?Loacation=19'">S</i>
                                        <i onclick="javascript:location='index.aspx?Loacation=20'">T</i>
                                    </p>
                                </span>
                                <span>
                                    <h2>U - x</h2>
                                    <p>
                                        <i onclick="javascript:location='index.aspx?Loacation=21'">U</i>
                                        <i onclick="javascript:location='index.aspx?Loacation=22'">V</i>
                                        <i onclick="javascript:location='index.aspx?Loacation=23'">W</i>
                                        <i onclick="javascript:location='index.aspx?Loacation=24'">X</i>
                                    </p>
                                </span>
                                <span>
                                    <h2>Y - z</h2>
                                    <p>
                                        <i onclick="javascript:location='index.aspx?Loacation=25'">Y</i>
                                        <i onclick="javascript:location='index.aspx?Loacation=26'">Z</i>
                                    </p>
                                </span>
                            </div>
                        </li>
            ...
            <div id="data_lc0" style="display: none;" lc_f_width="1708" lc_f_height="344" lc_btn_imgurl="../images/lcimages/b1/b1_btn.png" lc_imgurl="../images/lcimages/b1/b1_bg.png">
                ...
                <asp:Repeater ID="rptdata0lclist" runat="server">
                    <ItemTemplate>
                        ...
                        <lc lcnum="<%#Eval("lcnum")%>" lcname="<%#Eval("Title")%>" lcoverimgurl="<%#Eval("lcoverimgurl")%>" lcx="<%#Eval("lcx")%>" lcy="<%#Eval("lcy")%>"   <%# this.geturl(Eval("cgID").ToString() , Eval("fgID").ToString() , Eval("cgType").ToString())  %>   lccoords="<%#Eval("lccoords")%>"></lc>
                    </ItemTemplate>
                </asp:Repeater>
            </div>
            <div id="data_lc1" style="display: none;" lc_f_width="2160" lc_f_height="460" lc_btn_imgurl="../images/lcimages/f1/f1_btn.png" lc_imgurl="../images/lcimages/f1/f1_bg.png">
                ...
                <asp:Repeater ID="rptdatalc1list" runat="server">
                    <ItemTemplate>
                        <lc lcnum="<%#Eval("lcnum")%>" lcname="<%#Eval("Title")%>" lcoverimgurl="<%#Eval("lcoverimgurl")%>" lcx="<%#Eval("lcx")%>" lcy="<%#Eval("lcy")%>" a="<%#Eval("cgType")%>" <%# this.geturl(Eval("cgID").ToString() , Eval("fgID").ToString() , Eval("cgType").ToString())  %>     lccoords="<%#Eval("lccoords")%>"></lc>
                    </ItemTemplate>
                </asp:Repeater>
            </div>
