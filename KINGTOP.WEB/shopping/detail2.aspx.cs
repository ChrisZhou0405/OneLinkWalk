...
namespace KingTop.WEB.shopping
{
    public partial class detail2 : System.Web.UI.Page
    {
        ...
        private void BindRelated()
        {
            ...
            sql = "select ID,NodeCode,Title,type,ShopNo,Stereogram,LocationImg,TelPhone,SalesPro,SiteURL,IntroDetail,Shopshow,LikeImg,Orders,MetaKeyword,MetaDescript FROM K_U_CategoryGuide where isdel=0  and len(LikeImg)>0  and type  = (" + rid + ") and ID not in (" + id + ") and flowstate=99 and nodecode=101002002 order by orders desc";
