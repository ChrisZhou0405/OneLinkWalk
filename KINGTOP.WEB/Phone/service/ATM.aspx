<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ATM.aspx.cs" Inherits="KingTop.WEB.Phone.service.ATM" %>
  ...
  <div class="mmain bgwhite">
    ...
    <ul class="sernavlist">
            <li ><a href="/Phone/service/index.aspx"><span><img src="/Phone/images/aicon1.jpg"></span>咨询中心</a></li>
             ...
             <li class="hover"><a href="/Phone/service/ATM.aspx"><span><img src="/Phone/images/aicon3.jpg"></span>ATM设施</a></li>
     ...
     <div class="sitemaps">
       <%=KingTop.Common.Tools.GetSinglePageContent("101009006003")%>
