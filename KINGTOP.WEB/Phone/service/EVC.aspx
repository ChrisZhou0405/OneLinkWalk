<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EVC.aspx.cs" Inherits="KingTop.WEB.Phone.service.EVC" %>
...
<section>
  <div class="mmain bgwhite">
    ...
    <ul class="sernavlist">
             ...
             <li class="hover"><a href="/Phone/service/EVC.aspx"><span><img src="/Phone/images/aicon4.jpg"></span>电动汽车充电</a></li>
             <li><a href="/Phone/service/rooms.aspx"><span><img src="/Phone/images/aicon5.jpg"></span>母婴室</a></li>
         </ul>
        
     <div class="sitemaps">
     
       <%=KingTop.Common.Tools.GetSinglePageContent("101009006004")%>
      </div>
