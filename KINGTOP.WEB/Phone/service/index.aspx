<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="KingTop.WEB.Phone.service.index" %>
...
<section>
  <div class="mmain bgwhite">
    ...
    <ul class="sernavlist">
             <li class="hover"><a href="/Phone/service/index.aspx"><span><img src="/Phone/images/aicon1.jpg"></span>咨询中心</a></li>
     ...
     <div class="sitemaps">
        <%=KingTop.Common.Tools.GetSinglePageContent("101009006001")%>
      </div>
