<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="parking.aspx.cs" Inherits="KingTop.WEB.Phone.service.parking" %>
...
<section>
  <div class="mmain bgwhite">
    ...
    <ul class="sernavlist">
             ...
             <li  class="hover"><a href="/Phone/service/parking.aspx"><span><img src="/Phone/images/aicon2.jpg"></span>停车服务</a></li>
             ...
             <li><a href="/Phone/service/rooms.aspx"><span><img src="/Phone/images/aicon5.jpg"></span>母婴室</a></li>
         </ul>
        
     <div class="sitemaps">
     
         <%=KingTop.Common.Tools.GetSinglePageContent("101009006002")%>
      </div>
