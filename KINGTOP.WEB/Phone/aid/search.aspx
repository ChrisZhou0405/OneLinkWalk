<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="search.aspx.cs" Inherits="KingTop.WEB.Phone.aid.search" %>
...
<section>
  <div class="mmain bgwhite">
     <div class="curr"><h3>搜索结果</h3></div>    
     <div class="sitemaps">
        <div class="result">
            <p><span>SEARCH</span>搜索“<%=this.key %>”找到相关信息<%=this.sum %>条</p>
        </div>
        <ul class="searchlist">
           <%=this.lis %>
        </ul>
