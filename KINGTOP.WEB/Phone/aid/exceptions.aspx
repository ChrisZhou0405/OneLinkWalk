<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="exceptions.aspx.cs" Inherits="KingTop.WEB.Phone.aid.exceptions" %>
...
<section>
  <div class="mmain bgwhite">
     <div class="curr"><h3>私隐政策声明</h3></div>     
     
     <ul class="copyrightlist">
         <%=KingTop.Common.Tools.GetSinglePageContent("101008001")%>
     </ul>
