...
namespace KingTop.WEB.about
{
    public partial class lease : System.Web.UI.Page
    {
        ...
        private void BindProject()
        {
            ...
            sql = "select Title,RetalIntro,BigImg,listimage from K_U_Rental where NodeCode='101007004' and IsDel = 0 and FlowState = 99 order by orders asc";
