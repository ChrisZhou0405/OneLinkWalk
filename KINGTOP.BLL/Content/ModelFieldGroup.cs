...
namespace KingTop.BLL.Content
{
    public class ModelFieldGroup
    {
        ...
        private IDAL.Content.IModelFieldGroup dal = (IDAL.Content.IModelFieldGroup)Assembly.Load(path).CreateInstance(path+".Content.ModelFieldGroup");
        ...
        public string Save(string trantype, KingTop.Model.Content.ModelFieldGroup modModel)
        {
        ...
        {
            return dal.ModelFieldGroupSet(tranType, setValue, IDList);
        }
        #endregion
