...
namespace KingTop.BLL.SysManage
{
    public class UserGroupPermit
    {
        ...
        private IDAL.SysManage.IUserGroupPermit dal = (IDAL.SysManage.IUserGroupPermit)Assembly.Load(path).CreateInstance(path + ".SysManage.UserGroupPermit");
        ...
        public DataTable GetUserGroupPermitFromCache()
        {
            ...
            else
            {
                ...
                AppCache.Add("UserGroupPermitCache", dt, "K_SysUserGroupPermit");
                return dt;
            }
        }
        ...
        public string Save(string trantype, KingTop.Model.SysManage.UserGroupPermit UserGroupPermitModel)
        {
            return dal.Save(trantype, UserGroupPermitModel);
        }
        #endregion
        ...
        {
            return dal.UserGroupPermitSet(tranType, setValue, IDList, ExtendValue);
        }
        #endregion
    }
}
