...
namespace KingTop.BLL.SysManage
{
    public class RolePermit
    {
        ...
        private IDAL.SysManage.IRolePermit dal = (IDAL.SysManage.IRolePermit)Assembly.Load(path).CreateInstance(path + ".SysManage.RolePermit");
        ...
        public string Save(string trantype, KingTop.Model.SysManage.RolePermit RolePermitModel)
        {
            return dal.Save(trantype, RolePermitModel);
        }
        #endregion
        ...
        {
            return dal.RolePermitSet(tranType, setValue, IDList, ExtendValue);
        }
        #endregion
    }
}
