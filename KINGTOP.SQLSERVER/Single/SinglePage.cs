...
// 作者：严辉 2010-05-25
// 功能描述：对K_SinglePage表的的操作

// 更新日期        更新人      更新原因/内容
//
============================================================================*/

namespace KingTop.SQLServer.Single
{
    public class SinglePage : ISinglePage
    {
        ...
        public DataTable GetList(string tranType, KingTop.Model.SelectParams paramsModel)
        {
            ...
            return SQLHelper.ExecuteDataSet(SQLHelper.ConnectionStringLocalTransaction,
                      CommandType.StoredProcedure, "proc_K_SinglePageSel", prams).Tables[0];
        }
        #endregion
        ...
        public string SinglePageSet(string tranType, string setValue, string IDList)
        {
            ...
            try
            {
                ...
                SQLHelper.ExecuteNonQuery(SQLHelper.ConnectionStringLocalTransaction,
                          CommandType.StoredProcedure, "proc_K_SinglePageSet", prams);
                sRe = "1";
            }
            catch (Exception ex)
            {
        ...
        /// <returns>返回大于0的数字操作正常，返回非数字表示操作错误，返回的是系统错误说明</returns>
        public string Save(string tranType, KingTop.Model.Single.SinglePage paramsModel)
        {
            string isOk = "";
            try
            {
                ...
                string cmdText = "proc_K_SinglePageSave";
                ...
                SqlParameter[] paras = new SqlParameter[]{
                    ...
                    new SqlParameter("ClassID",paramsModel.ClassID),
        ...
        public void PageData(KingTop.Model.Pager pager)
        {
            SqlParameter[] prams = new SqlParameter[]{
                ...
                new SqlParameter("@Table","K_SinglePage"),             
