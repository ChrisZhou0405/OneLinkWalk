    ...
    public class WebSiteTemplate : IWebSiteTemplate
    {
        ...
        public DataTable GetList(string tranType, KingTop.Model.SelectParams paramsModel)
        {
            ...
            return SQLHelper.ExecuteDataSet(SQLHelper.ConnectionStringLocalTransaction,
                      CommandType.StoredProcedure, "proc_K_WebSiteTemplateSel", prams).Tables[0];
        }
        #endregion
        ...
        public string TemplateSet(string tranType, string setValue, string IDList)
        {
            ...
            try
            {
                ...
                SQLHelper.ExecuteNonQuery(SQLHelper.ConnectionStringLocalTransaction,
                          CommandType.StoredProcedure, "proc_K_WebSiteTemplateSet", prams);
                sRe = "1";
            }
            catch (Exception ex)
            {
        ...
        public void PageData(KingTop.Model.Pager pager)
        {
            SqlParameter[] prams = new SqlParameter[]{
                ...
                new SqlParameter("@Table","K_WebSiteTemplate"),             
                ...
                new SqlParameter("@order","TemplateID DESC"),                
