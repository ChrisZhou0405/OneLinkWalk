...
namespace KingTop.Common
{
    ...
    public class Tools
    {
        ...
        public static DataTable GetDataSet(string sql)
        {
            ...
            dt = KingTop.Common.SQLHelper.ExecuteDataSet(SQLHelper.ConnectionStringLocalTransaction, CommandType.Text, sql).Tables[0];
            return dt;
        }
        #endregion
        ...
        {
            DataTable dt = new DataTable();
            dt = KingTop.Common.SQLHelper.ExecuteDataSet(SQLHelper.ConnectionStringLocalTransaction, CommandType.StoredProcedure, "proc_SplitPager", param).Tables[1];
            return dt;
        }
        #endregion
        ...
        //{
        //    KingTop.BLL.Single.SinglePage bllSinglePage = new KingTop.BLL.Single.SinglePage();
        ...
        //{
        //    KingTop.BLL.Content.Advertisement bllAdvertisement = new KingTop.BLL.Content.Advertisement();
        ...
        //{
        //    KingTop.BLL.LinkManage.FriendLink bllFriendLink = new KingTop.BLL.LinkManage.FriendLink();
        //    KingTop.Model.SelectParams param = new KingTop.Model.SelectParams();
