...
namespace KingTop.Common
{
    ...
    public class SystemConst
    {
        ...
        /// 最大保存cookie子集
        /// </summary>
        public static readonly int intMaxCookiePageCount = 15;
        ...
        /// 禁止上传的文件类型
        /// </summary>
        public static readonly string NOT_ALLOWED_UPLOAD_TYPE = "asa|asax|ascx|ashx|asmx|asp|aspx|axd|cdx|cer|config|cs|csproj|idc|licx|rem|resources|resx|shtm|shtml|soap|stm|vb|vbproj|vsdisco|webinfo|js|php|jsp";
