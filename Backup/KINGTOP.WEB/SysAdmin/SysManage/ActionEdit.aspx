<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActionEdit.aspx.cs" Inherits="KingTop.WEB.SysAdmin.SysManage.ActionEdit" %>
    ...
    <script type="text/javascript">
        ...
        function showMessage() {
            ...
            if (type == 0) {
                ...
                msgContent += "<a href='ActionEdit.aspx?<%=KingTop.Common.Utils.GetUrlParams() %>' style='color:red'>继续修改</a> | ";
