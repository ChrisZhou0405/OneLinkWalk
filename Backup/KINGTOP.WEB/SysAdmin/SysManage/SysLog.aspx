<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysLog.aspx.cs" Inherits="KingTop.WEB.SysAdmin.SysManage.SysLog" %>
    ...
    <input type="hidden" name="hidLogTitle" id="hidLogTitle" runat ="server" />
        ...
        <div id="searchContainer">
            <p>
                ...
                <asp:Button ID="btnSearch" runat="server" OnClick="btnQuery_Click" Text="<%$Resources:Common,Search %>"/></p>
        </div>   
        <div class="function">
