<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleEdit.aspx.cs" Inherits="KingTop.WEB.SysAdmin.SysManage.RoleEdit" %>
    ...
    <script type="text/javascript">
        ...
        //添加成功
            if (type == 0) {
                ...
                msgContent+="<a href='RoleEdit.aspx?<%=KingTop.Common.Utils.GetUrlParams()%>' style='color:red'>继续修改</a> | ";
