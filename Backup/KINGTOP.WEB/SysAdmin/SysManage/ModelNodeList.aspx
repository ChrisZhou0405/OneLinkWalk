<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModelNodeList.aspx.cs"
    Inherits="KingTop.WEB.SysAdmin.SysManage.ModelNodeList" %>
...
<head>
    ...
    <script language="javascript">
        function setAction1(data, NodeID, NodeCode) {
            if (data == "true") {
                location.href = 'ModelNodeList.aspx?Action=Del&NodeID=' + NodeID + '&ThisCode=' + NodeCode + '&NodeCode=<%=NodeCode %>';
            }
        }
    </script>
</head>
