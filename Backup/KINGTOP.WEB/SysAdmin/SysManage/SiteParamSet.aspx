<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SiteParamSet.aspx.cs" Inherits="KingTop.WEB.SysAdmin.SysManage.SiteParamSet" %>
...
<body>
    ...
    <div class="container">
        ...
        <div id="panel">
                ...
                <dl id="dl1" style="display:none" runat ="server">
                ...
                <dl id="dlsubdomain" runat="server">
                    <dt width="30%"><b>本站点域名：</b><br>注意：本站点域名的主目录需设置到网站生成目录文件夹，<br />不填写则本站点域名为“网站根域名+网站生成目录，例如：http://www.toprand.com/shop/，shop为网站生成目录” </dt>
                    <dd width="70%"><asp:TextBox ID="txtSiteDomain" runat="server" width="300px"></asp:TextBox></dd>
                </dl>
                <dl id="dlPublishType" runat ="server">
                    <dt width="30%"><b>网站发布方式：</b> </dt>
                    <dd width="70%">
                    
                    <input type="radio" id="radPublishType0" name="radPublishType" value="0" runat="server"/> 动态 &nbsp; 
                    <input type="radio" id="radPublishType1" name="radPublishType" value="1" runat="server"/> 伪静态
                     &nbsp; <input type="radio" id="radPublishType2" name="radPublishType" value="2" runat="server"/> 纯静态
                    </dd>
                </dl>
                <dl id="dlSiteDir" runat ="server">
                    <dt width="30%"><b>网站生成目录：</b><br />发布为纯静态时设置有用 </dt>
                ...
                <dl style="display:none">
                    <dt width="30%"><b>生成文件扩展名：</b><br />发布为纯静态时设置有用<br />此项设置生成静态页面的扩展名 </dt>
                ...
                <dl>
                    ...
                    <asp:ListItem Value="ueditor">UEditor</asp:ListItem>
                    <asp:ListItem Value="ueditormini">UEditor Mini</asp:ListItem>
