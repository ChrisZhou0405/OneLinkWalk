...
namespace KingTop.Web.Admin
{
    ...
    {
        KingTop.Modules.Entity.Member modelMember;
        //Model.Member.MemberDetail modelMemberDetail;

        KingTop.Modules.BLL.Member bllMember = new KingTop.Modules.BLL.Member();
        //BLL.Member.MemberDetail bllMemberDetail = new KingTop.BLL.Member.MemberDetail();
        
        //会员模型相关类
        //Model.Business.BusinessField modelField = new KingTop.Model.Business.BusinessField();
        //KingTop.BLL.Business.BusinessModel bllBusinessModel = new KingTop.BLL.Business.BusinessModel();
        //KingTop.BLL.Business.BusinessFieldValue bllBusinessFieldValue = new KingTop.BLL.Business.BusinessFieldValue();     
        //Model.Business.BusinessFieldValue modelBusinFieldValue = new KingTop.Model.Business.BusinessFieldValue();
        ...
        {
            //绑定会员组下拉框
            //BLL.Member.MemberGroup bllMemberGroup = new BLL.Member.MemberGroup();
            ...
            //绑定会员模型下拉框
            //BLL.Business.BusinessModel bllBusinessModel = new KingTop.BLL.Business.BusinessModel();
            ...
            //所在地区
            // BLL.Categorys.Category bllCategory = new KingTop.BLL.Categorys.Category();
            ...
            if (Action == "EDIT")
            {
                ...
                #region 基本信息
                //基本信息
                DataTable dtMember = bllMember.GetList("ONE", KingTop.Modules.Tools.getOneParams(MemberID));
                ...
                ////dtSelf = bllBusinessModel.GetList("DEFINE", KingTop.Common.Utils.getTwoParams(modelID, MemberID));
                //dtSelf = bllBusinessModel.GetList("BORN", KingTop.Common.Utils.getTwoParams(modelID, MemberID));
        ...
        //{
            //保存详细信息
            //modelMemberDetail = new KingTop.Model.Member.MemberDetail();
        ...
        private void SaveOrUpdateSelf()
        {
            ...
            //KingTop.BLL.Business.BusinessInfo bllBusinessInfo = new KingTop.BLL.Business.BusinessInfo();
            //KingTop.Model.Business.BusinessInfo modleBusinessInfo = new KingTop.Model.Business.BusinessInfo();
        ...
        private void InitModel()
        {
            ...
            modelMember.Gender = rblGender.SelectedValue;
        ...
        protected void lnkbEditModel_Click(object sender, EventArgs e)
        {
            if (IsHaveRightByOperCode("Edit"))
            {
                Utils.UrlRedirect("MemberOnlyModelEdit.aspx?memberID=" + MemberID);
            }
            else
            {
                Utils.AlertMessage(this, "你没有修改权限！");
