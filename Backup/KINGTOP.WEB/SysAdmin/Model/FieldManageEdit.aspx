...
<body>
    ...
    <div class="container">
        ...
        <dl>
            ...
            <dd>
                <asp:RadioButtonList ID="radlBasicField" runat="server" RepeatColumns="6" RepeatDirection="Horizontal">
                    ...
                    <asp:ListItem Value="15" Text="密码"></asp:ListItem>
                </asp:RadioButtonList>
            </dd>
        </dl>
        ...
        <div id="BasicField_3" style="display:none">
            <dl>
                <dt>
                    ...
                    <ul style="list-style: none;">
                        <li style="float: left; list-style: none;">
                            <asp:DropDownList ID="ddlEditorType" runat="server" onclick="onEditorChange()">
                                <asp:ListItem Value="3" Text="ueditor"></asp:ListItem>
        ...
        <div id="BasicField_4">
            ...
            <div id="DropDownDataType2" style="display: none">
                ...
                <dl>
                    ...
                    <dd>
                        <asp:TextBox runat="server" ID="txtDropDownSqlWhere" onchange="selectColumnSql()" style="width:500px"></asp:TextBox> <br />(不用填写Where,如 NodeCode='"+NodeCode.Substring(0,3)+"001001' and isDel=0 order by Orders Desc)</dd>
                </dl>
                <dl>
                    <dt>
        ...
        <div id="BasicField_11">
            <span id="BasicField_ImagesBestShow" style="display :none">
            <dl>
                <dt>
                    上传图片最佳宽度：</dt>
                <dd>
                    <asp:TextBox runat="server" ID="txtImageBestWidth"></asp:TextBox>只能填写数字，设置后会在图片上传那里显示，下同</dd>
            </dl>
            <dl>
                <dt>
                    上传图片最佳高度：</dt>
                <dd>
                    <asp:TextBox runat="server" ID="txtImageBestHeight"></asp:TextBox></dd>
            </dl>
            </span>
            ...
            <!--相册功能取消上传小图和描述功能，这两个功能在实际应用中几乎不存在，现在统一改成一种相册方式-->
        ...
        <div class="Submit">
            <asp:Button ID="btnModelField" CssClass="subButton" runat="server" OnClick="btnModelField_Click" Text="<%$Resources:Common,Add%>" />
            <input type="button" Class="subButton" name="Submit422" value="<%=Resources.Common.Back%>" onclick="javascript:location.href='FieldManageList.aspx?<%=UrlParam %>';">
        </div>
